...
from python_helloworld.section_ii.project_a.chapter_14.example_3.bullet \
    import Bullet


def start_game(ai_settings, stats, ship, rectangle, bullets):
    """
...
def check_play_button(ai_settings, stats, play_button, ship, rectangle, bullets, mouse_x,
                      mouse_y):
    """在玩家单击Play按钮时开始新游戏"""
    button_clicked = play_button.rect.collidepoint(mouse_x, mouse_y)
    if button_clicked and not stats.game_active:
        start_game(ai_settings, stats, ship, rectangle, bullets)
...
def check_events(ai_settings, screen, stats, play_button, ship, rectangle,
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, stats, play_button, ship,
...
def check_bullet_rectangle_collisions(ai_settings, stats, rectangle, bullets):
    """响应子弹和外星人的碰撞"""
    # 删除发生碰撞的子弹和外星人
...
def update_bullets(ai_settings, stats, rectangle, bullets):
    bullets.update()
    # 删除消失的子弹
    for bullet in bullets.copy():
        ...
        # 检查是否有子弹击中了外星人
        # 如果是这样，就删除相应的子弹和外星人
    check_bullet_rectangle_collisions(ai_settings, stats, rectangle, bullets)
