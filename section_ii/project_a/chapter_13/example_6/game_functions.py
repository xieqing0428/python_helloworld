...
from python_helloworld.section_ii.project_a.chapter_13.example_6.ball import \
    Ball
...
def update_balls(ball_settings, screen, stats, hands, balls):
    """更新球的位置"""
    balls.update()
    # 删除消失的球
